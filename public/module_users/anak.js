...
$(document).ready(function(){
	 ...
	 table = $('#anak').DataTable( {
		...
		"order": [],
			"ajax": {
						"url": urlGlobal+"index/data_anak_data",
				        "type": "POST"
		        	},
		    "aoColumns": [	
                            {
...
function edit(id_anak)
{
    ...
    $.ajax({
        url : urlGlobal+"index/anak_edit_data/" + id_anak,
        type: "GET",
        dataType: "JSON",
...
function del(id_anak)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : urlGlobal+"index/anak_delete_data/"+ id_anak,
            type: "POST",
            dataType: "JSON",
            success: function(dataRow)
            {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = urlGlobal+"index/anak_insert_data";
    } else {
        url = urlGlobal+"index/anak_update_data";
    }
