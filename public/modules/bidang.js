...
$(document).ready(function(){
	 ...
	 table = $('#bidang').DataTable( {
		...
		"order": [],
			"ajax": {
						"url": urlGlobal+"administrator/bidang_data",
				        "type": "POST"
		        	},
		    "aoColumns": [	
                            {
...
function edit(id_bidang)
{
    ...
    $.ajax({
        url : urlGlobal+"administrator/bidang_edit_data/" + id_bidang,
        type: "GET",
        dataType: "JSON",
...
function del(id_bidang)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : urlGlobal+"administrator/bidang_delete_data/"+ id_bidang,
            type: "POST",
            dataType: "JSON",
            success: function(dataRow)
            {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = urlGlobal+"administrator/bidang_insert_data";
    } else {
        url = urlGlobal+"administrator/bidang_update_data";
    }
